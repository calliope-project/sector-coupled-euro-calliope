...
mkdir -p "${DIR}/build/eurospores/spores_2h" "${DIR}/build/logs/spores_continue_2h"

python "${DIR}/run_scripts/continue_spores.py" "${DIR}/build/eurospores/spores_2h/${LSB_JOBINDEX}-${array[${LSB_JOBINDEX}-1]}/"
