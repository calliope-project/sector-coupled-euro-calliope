...
#BSUB -W 7200
#BSUB -r
#BSUB -o /cluster/work/cpesm/brynmorp/euro-spores/logs/spores_continue/log_%I.log
...
mkdir -p "${DIR}/outputs/spores_full" "${DIR}/logs/spores_continue" "${DIR}/outputs/spores_full/${LSB_JOBINDEX}-${array[${LSB_JOBINDEX}-1]}"

python "${DIR}/run_scripts/continue_spores.py" "${DIR}/outputs/spores_full/${LSB_JOBINDEX}-${array[${LSB_JOBINDEX}-1]}/"
