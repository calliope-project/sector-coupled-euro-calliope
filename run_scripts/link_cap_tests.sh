...
calliope run --scenario "industry_fuel,transport,heat,config_overrides,res_3h,${array[${LSB_JOBINDEX}-1]}" --save_netcdf "${DIR}/outputs/${array[${LSB_JOBINDEX}-1]}.nc" "${DIR}/build/model/eurospores/model.yaml"