...
mkdir -p "${DIR}/build/eurospores/spores_2h_15slack" "${DIR}/build/logs/spores_continue_2h_15slack"

python "${DIR}/run_scripts/continue_spores.py" "${DIR}/build/eurospores/spores_2h_15slack/${LSB_JOBINDEX}-${array[${LSB_JOBINDEX}-1]}/" --slack 0.15
